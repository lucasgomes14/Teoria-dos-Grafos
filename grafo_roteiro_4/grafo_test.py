...
class TestGrafo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.teste = MeuGrafo(['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K'])
        self.teste.adicionaAresta('1', 'A', 'B')
        self.teste.adicionaAresta('2', 'A', 'G')
        self.teste.adicionaAresta('3', 'A', 'J')
        self.teste.adicionaAresta('4', 'G', 'K')
        self.teste.adicionaAresta('5', 'K', 'J')
        self.teste.adicionaAresta('6', 'J', 'G')
        self.teste.adicionaAresta('7', 'J', 'I')
        self.teste.adicionaAresta('8', 'I', 'G')
        self.teste.adicionaAresta('9', 'G', 'H')
        self.teste.adicionaAresta('10', 'H', 'F')
        self.teste.adicionaAresta('11', 'F', 'B')
        self.teste.adicionaAresta('12', 'B', 'G')
        self.teste.adicionaAresta('13', 'B', 'C')
        self.teste.adicionaAresta('14', 'C', 'D')
        self.teste.adicionaAresta('15', 'D', 'E')
        self.teste.adicionaAresta('16', 'D', 'B')
        self.teste.adicionaAresta('17', 'B', 'E')
    ...
    def test_dfs(self):
        ...
        self.assertEqual(set(self.teste.dfs('A').A.keys()), set(['1', '11', '10', '9', '4', '5', '7', '13', '14', '15']))
        self.assertEqual(set(self.teste.dfs('D').A.keys()), set(['14', '13', '1', '2', '4', '5', '7', '9', '10', '17']))
    ...
    def test_bfs(self):
        ...
        self.assertEqual(set(self.teste.bfs('A').A.keys()), set(['1', '2', '3', '11', '13', '16', '17', '4', '8', '9']))
        self.assertEqual(set(self.teste.bfs('D').A.keys()), set(['14', '15', '16', '1', '11', '12', '3', '10', '4', '8']))