...
class TestGrafo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.g_g4 = MeuGrafo(['A', 'B', 'C', 'D', 'E'])
        self.g_g4.adicionaAresta("a1", "A", "B", 3)
        self.g_g4.adicionaAresta("a2", "A", "D", 1)
        self.g_g4.adicionaAresta("a3", "A", "E", 2)
        self.g_g4.adicionaAresta("a4", "C", "E", 1)
        self.g_g4.adicionaAresta("a5", "C", "D", 2)
        self.g_g4.adicionaAresta("a6", "D", "E", 5)
    ...
    def test_kruskal(self):
        self.assertEqual(set(self.g_p.kruskal().A.keys()), set(['a7', 'a8', 'a1', 'a4', 'a9', 'a2']))
        self.assertEqual(set(self.g_c.kruskal().A.keys()), set(['a6', 'a1', 'a3']))
        self.assertEqual(set(self.g_p4.kruskal().A.keys()), set(['a2', 'a9', 'a7', 'a1', 'a8', 'a4']))
        self.assertEqual(set(self.teste1.kruskal().A.keys()), set(['3', '14', '1', '17', '16', '5', '8', '11', '10', '7']))
        self.assertEqual(set(self.teste2.kruskal().A.keys()), set(['a2', 'a6', 'a1', 'a3', 'a4']))
        self.assertEqual(set(self.g_g2.kruskal().A.keys()), set(['a1', 'a7', 'a6', 'a12', 'a10', 'a11', 'a3', 'a2']))
        self.assertEqual(set(self.g_g3.kruskal().A.keys()), set(['a6', 'a1', 'a2', 'a3', 'a8']))
        self.assertEqual(set(self.g_g4.kruskal().A.keys()), set(['a1', 'a2', 'a3', 'a4']))
        self.assertEqual(set(self.g_t1.kruskal().A.keys()), set(['a3', 'a5', 'a1', 'a8', 'a7', 'a12', 'a11', 'a9']))
        self.assertEqual(set(self.g_t2.kruskal().A.keys()), set(['8', '7', '16', '13', '3', '4', '10', '1', '17', '9']))

    def test_prim(self):
        self.assertEqual(set(self.g_p.prim().A.keys()), set(['a4', 'a7', 'a1', 'a9', 'a2', 'a8']))
        self.assertEqual(set(self.g_c.prim().A.keys()), set(['a3', 'a6', 'a1']))
        self.assertEqual(set(self.g_p4.prim().A.keys()), set(['a8', 'a1', 'a4', 'a9', 'a2', 'a7']))
        self.assertEqual(set(self.teste1.prim().A.keys()), set(['7', '10', '17', '1', '16', '5', '8', '14', '9', '3']))
        self.assertEqual(set(self.teste2.prim().A.keys()), set(['a3', 'a1', 'a4', 'a2', 'a6']))
        self.assertEqual(set(self.g_g2.prim().A.keys()), set(['a12', 'a7', 'a1', 'a3', 'a9', 'a2', 'a6', 'a11']))
        self.assertEqual(set(self.g_g3.prim().A.keys()), set(['a6', 'a8', 'a2', 'a3', 'a1']))
        self.assertEqual(set(self.g_g4.prim().A.keys()), set(['a3', 'a2', 'a1', 'a4']))
        self.assertEqual(set(self.g_t1.prim().A.keys()), set(['a3', 'a9', 'a7', 'a11', 'a8', 'a12', 'a1', 'a5']))
        self.assertEqual(set(self.g_t2.prim().A.keys()), set(['10', '16', '4', '1', '17', '7', '13', '3', '8', '9']))
